...
export class ContentService {
  contents: ContentModel[] = [
    ...
    new ContentModel(true, false, "Github Alert", "New pull request needs review.", "10:15", true),
    new ContentModel(false, false, "System Update", "Your system will restart tonight to install updates.", "02:45", true),
    ...
    new ContentModel(false, false, "Promotion", "50% discount on your next purchase, valid until Friday.", "11:20", true),
    ...
    new ContentModel(false, false, "App Notification", "You have unlocked a new achievement.", "17:40", true),
    new ContentModel(true, true, "Bank Alert", "A deposit of $500 has been made to your account.", "14:22", true),
    new ContentModel(true, false, "Code Review", "Your code was approved and merged into the main branch.", "16:35", true),
    new ContentModel(false, false, "Weather Update", "Heavy rain expected this weekend in your area.", "06:10"),
    new ContentModel(false, false, "Flight Status", "Your flight to Paris has been delayed by 2 hours.", "12:00", true),
